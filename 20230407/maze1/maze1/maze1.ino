...
#define TRIG1 2 //초음파센서 1번 trig 핀 번호
#define ECHO1 3 //초음파센서 1번 trig 핀 번호

#define TRIG2 4 //초음파센서 1번 trig 핀 번호
#define ECHO2 5 //초음파센서 1번 trig 핀 번호

#define TRIG3 6 //초음파센서 1번 trig 핀 번호
#define ECHO3 7 //초음파센서 1번 trig 핀 번호
...
long sonar_front(void) //초음파센서  1번 측정 함수
{
...
long sonar3(void) //초음파센서  1번 측정 함수
{
  // put your main code here, to run repeatedly:
  long duration, distance;
...
void check_maze_status(void)
{
  ...
  else if ((left_sonar >= 0) && (right_sonar <= 200) && (front_sonar >= 0) && (front_sonar <= 200))
  {
    maze_status = 3;
...
void loop()
{
  ...
  /*  Serial.print("Distance1: ");
    Serial.println(sonar[Front].ping_cm());
    Serial.print("Distance2: ");
    Serial.print(sonar2());
    Serial.print("Distance3: ");
    Serial.println(sonar3());

    if(front_sonar <= 250.0)
    {
    // 180도 회전 시계방향
